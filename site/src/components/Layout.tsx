      ...
      <header className="sticky top-0 z-50 border-b border-zinc-800 bg-zinc-950">
        <div className="px-4 h-14 flex items-center justify-between">
          ...
          <a
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-md border border-zinc-800 text-sm text-zinc-400 hover:text-zinc-50 hover:border-zinc-700 transition-colors"
          >
            <StarIcon />
