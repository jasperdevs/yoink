...
export default function Layout() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-[#F6F6F6] text-black">
      ...
      >
        <div className="mx-auto max-w-[800px] px-6 sm:px-8 h-14 flex items-center justify-between gap-4">
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center gap-1.5 text-[13px] sm:text-[14px] text-black/60 hover:text-black transition-colors"
          >
