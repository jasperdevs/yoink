...
public static class OpenSourceTranslationRuntimeService
{
    ...
    private static readonly string RootDir = Path.Combine(
        Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Yoink", "translate-local");
    ...
    private static string NormalizePythonError(string message)
    {
        ...
        {
            return "Existing local translation files were incomplete. Retry install and Yoink will rebuild them.";
        }
